...
*/
#define CLIENT_MAX_CONNECTIONLOST_COUNT 50


//each trigger (3s) will increase user->connectionLostCounter
#define CLIENT_CONNECTIONLOST_TIMER_INTERVAL 3000 //3s


/*
   every 5s send CommandHandler::PING_DATA to users and
...
*/
#define SERVER_PING_USERS_TIMER_INTERVAL 5000 //5s
